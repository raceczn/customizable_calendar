...
import { getClosest, setTheme, throttle } from "../utilities/helpers";
...
const sbCategoriesWrapper = document.querySelector(
...
export default function renderViews(context, datepickerContext, store) {
  ...
  function handleBtnNavigation(direction) {
    ...
    if (config) {
      handleTransition(
        typeof config.element === "function"
          ? config.element()
          : config.element,
        transitionDirection,
        config.action
  ...
  function handleSelect() {
    ...
    const setOption = (e) =>
      renderOption(e.target.getAttribute("data-view-option"));
  ...
  function handleCollapse() {
    ...
    if (view === "week" || view === "day") {
      ...
      if (view === "day") {
        document
          .querySelector(".dayview--header")
          .classList.toggle("dvh-collapse");
      } else {
        document
          .querySelector(".weekview--header")
          .classList.toggle("wvh-collapse");
        document
          .querySelector(".weekview__grid")
          .classList.toggle("wvh-body-collapse");
      }
    }
  }
